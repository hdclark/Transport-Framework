//Beams_10MeV_Photons.cc - Basic, static beam qualities for a 10 MeV photon beam. 
//
//Programming notes:
...
//This function simply returns a perfect 10.0 MeV energy spectrum.
//
