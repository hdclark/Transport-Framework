//Beam_6MV_Downward.cc - Basic, static beam qualities for a 6MV photon beam. Fluence is given in terms of binned data. Beam is directed downward. 
//
//Programming notes:
...
//vec3<double> position(0.0, 0.0, 0.0); //The geometric location of the beams 'spout.'
