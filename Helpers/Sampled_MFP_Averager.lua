...
file_input    = "/tmp/Transport_Sampled_MFP.process"
file_output   = "/tmp/Transport_Sampled_MFP.plot"
numb_of_bins  = 250   --The upper limit on the number of bins.
heading       = " Energy    Average MFP "
