...
--Bins and averages stopping distance (from origin.) 
...
file_input    = "/tmp/Transport_electron_stop.process"
file_output   = "/tmp/Transport_electron_stop.plot"
numb_of_bins  = 100   --The upper limit on the number of bins.
heading       = " Distance     Relative Intensity (normalized to total output)"
...
for n1, n2, n3, n4, n5 in string.gfind(io.read("*all"), pattern) do
        --print(n1 .. " " .. n2 .. " " .. n3 .. " " .. n4 .. " " .. n5 )  --troubleshooting.
        n1 = tonumber(n4)
