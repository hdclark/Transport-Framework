...
--Bins and averages spectral data. 
...
file_input    = "/tmp/Transport_Fraction_Transferred_Compton.process"
file_output   = "/tmp/Transport_Fraction_Transferred_Compton.plot"
numb_of_bins  = 150   --The upper limit on the number of bins.
heading       = " Energy    Averaged fraction of energy transferred to recoil electrons "
...
output = {} --The indices of the output denote x-values (bins), the value denote the y-values.
count  = {} --The indices of the output denote x-values (bins), the value denote the number of x-values within the bin.
...
for i=0,(numb_of_bins-1) do
    if output[i] ~= 0 and count[i] ~= 0 then  
