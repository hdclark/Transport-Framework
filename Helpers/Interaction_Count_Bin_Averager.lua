...
file_input    = "/tmp/Transport_Interaction_Count.process"
file_output   = "/tmp/Transport_Interaction_Count.plot"
numb_of_bins  = 15   --The upper limit on the number of bins.
heading       = " Energy    Bin size (averaged intensity) "
