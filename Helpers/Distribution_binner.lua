...
--Bins and averages a distribution function so that it can be glance-tested. Obviously, this is not a rigorous test! 
...
file_input    = "/tmp/Transport_Sampled_Gaussian.process"
file_output   = "/tmp/Transport_Sampled_Gaussian.plot"
